...
import '../controller/intelligent_image_generate_controller.dart';

class IntelligentImageGenerateView extends StatefulWidget {
  const IntelligentImageGenerateView({super.key});

  @override
  State<IntelligentImageGenerateView> createState() =>
      _IntelligentImageGenerateViewState();
}

class _IntelligentImageGenerateViewState
    extends State<IntelligentImageGenerateView> {
  late final IntelligentImageGenerateController controller =
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      title: const FittedBox(
        fit: BoxFit.fitWidth,
        child: Text("Intelligent Image Generate"),
      ),
      actions: [
        IconButton(
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: '请输入跟生成图片有关的内容',
                  suffixIcon: controller.showClearIcon
                      ? IconButton(
                          onPressed: () {
