...
import '../controller/intelligent_image_edit_controller.dart';

class IntelligentImageEditView extends StatefulWidget {
  const IntelligentImageEditView({super.key});

  @override
  State<IntelligentImageEditView> createState() =>
      _IntelligentImageEditViewState();
}

class _IntelligentImageEditViewState extends State<IntelligentImageEditView> {
  late final IntelligentImageEditController controller =
      IntelligentImageEditController(
    refreshInterface: () {
      setState(() {});
    },
  );
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      title: const FittedBox(
        fit: BoxFit.fitWidth,
        child: Text("Intelligent Image Edit"),
      ),
      actions: [
        IconButton(
